...
def convert_cleaned_data_to_json():
    ...
    structured_path = os.path.join(output_dir, "sales_data_structured.json")
    with open(structured_path, 'w', encoding='utf-8') as f:
        json.dump(json_data_structured, f, indent=2, ensure_ascii=False)
